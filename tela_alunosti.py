...
# JANELA 
label_cadastro = Label(janela, text='Cadastro de alunos do curso T.I', fg='black', bg='#008B8B', font=('Arial','30'), justify='center')
label_cadastro.pack(side=TOP)

# FRAME 1 
label_ra = Label(text='CPF do aluno', fg='black', bg='#008B8B', font=('','14'))
...
label_Cidade = Label(text='Cidade', fg='black', bg='#008B8B', font=('','14'))
...
label_UF = Label(text='UF', fg='black', bg='#008B8B', font=('','14'))
