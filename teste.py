...
# JANELA 
label_cadastro = Label(janela, text='Cadastro de alunos do curso T.I', fg='black', bg='#483D8B', font=('cambria','30'), justify='center')
label_cadastro.pack(side=TOP)

# FRAME 1 
label_ra = Label(text='CPF do aluno', fg='black', bg='#483D8B', font=('','16'))
...
label_nome = Label(text='Nome do aluno', fg='black', bg='#483D8B', font=('','16'))
label_nome.place(x=26, y=120)

entry_nome = Entry(font=('Arial','12'), relief='solid')
entry_nome.place(x=175,y=122,height=28,width=500)

label_CEP = Label(text='CEP', fg='black', bg='#483D8B', font=('','16'))
label_CEP.place(x=105,y=160)

entry_CEP= Entry(font=('Arial','12'), relief='solid')
entry_CEP.place(x=175,y=162,height=28,width=250)

label_endereco = Label(text='Endereço', fg='black', bg='#483D8B', font=('','16'))
label_endereco.place(x=70,y=200)

entry_endereco = Entry(font=('Arial','12'), relief='solid')
entry_endereco.place(x=175,y=200,height=28,width=500)

label_Cidade = Label(text='Cidade', fg='black', bg='#483D8B', font=('','16'))
label_Cidade.place(x=90,y=240)

entry_Cidade= Entry(font=('Arial','12'), relief='solid')
entry_Cidade.place(x=175,y=240,height=28,width=500)

label_UF = Label(text='UF', fg='black', bg='#483D8B', font=('','16'))
label_UF.place(x=120,y=280)

entry_UF= Entry(font=('Arial','12'), relief='solid')
entry_UF.place(x=175,y=280,height=28,width=500)
...
botao_inserir.place(x=300,y=400,width=80,height=30)

botao_excluir = Button(text='Excluir',command=deletar_registro,font=('','12'),relief='groove', fg='black', activeforeground='orange')
botao_excluir.place(x=440,y=400,width=80,height=30)
